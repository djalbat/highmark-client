...
class CheckmarkSVG extends SVG {
  childElements() {
    return (
  ...
  parentContext() {
    const showCheckmarkSVG = this.show.bind(this),  ///
          hideCheckmarkSVG = this.hide.bind(this),  ///
          isCheckmarkSVGShowing = this.isShowing.bind(this);  ///

    return ({
      showCheckmarkSVG,
      hideCheckmarkSVG,
      isCheckmarkSVGShowing
    });
  }
...
export default withStyle(CheckmarkSVG)`
